...
----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|--------|
 ...
 AWS_ACCESS_KEY_ID                            | The access key ID of the AWS user that efs-submission-api will use when connecting to AWS                                                | MYAWSACCESSKEYID                                    |local
 AWS_SECRET_ACCESS_KEY                        | The secret access key of the AWS user that efs-submission-api will use when connecting to AWS                                            | MYAWSSECRETACCESSKEY                                |local

...
| <a name="module_secrets"></a> [secrets](#module\_secrets) | git@github.com:companieshouse/terraform-modules//aws/ecs/secrets | 1.0.346 |
...
| [aws_kms_grant.file_transfer_encryption_key_grant](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/key_grant) | resource |
...
| [aws_s3_bucket.payments_reports_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/s3_bucket) | data source |
| [aws_s3_bucket.s3_av_bucket](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/s3_bucket) | data source |
| [aws_sqs_queue.efs_doc_processor_queue](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/sqs_queue) | data source |
...
| <a name="input_efs_submission_api_version"></a> [efs\_submission\_api\_version](#input\_efs\_submission\_api\_version) | The version of the efs-submission-api container to run. | `string` | n/a | yes |
...
| <a name="input_file_transfer_kms_alias"></a> [file\_transfer\_kms\_alias](#input\_file\_transfer\_kms\_alias) | The alias of the KMS key used for file transfer encryption. | `string` | n/a | yes |
...
| <a name="input_min_task_count"></a> [min\_task\_count](#input\_min\_task\_count) | The maximum number of tasks for this service. | `number` | `1` | no |
